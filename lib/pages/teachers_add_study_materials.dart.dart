...
class teacher_add_studymaterial extends StatefulWidget {
  const teacher_add_studymaterial({super.key});

  @override
  State<teacher_add_studymaterial> createState() => _teacher_add_studymaterialState();
}

class _teacher_add_studymaterialState extends State<teacher_add_studymaterial> {
  ...
  void addstudymaterial() async{
    ...
    try{
      ...
      if(selectedfile != null){
        await FirebaseStorage.instance.ref().child("Study-materials-image/${con1.text}").putFile(selectedfile);
      }
