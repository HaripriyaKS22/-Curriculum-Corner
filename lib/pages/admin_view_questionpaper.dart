...
class admin_view_questionpaper extends StatefulWidget {
  var year;
  var education;
   admin_view_questionpaper( {this.year,this.education});

  @override
  State<admin_view_questionpaper> createState() => _admin_view_questionpaperState();
}

class _admin_view_questionpaperState extends State<admin_view_questionpaper> {
