...
class user_choose_cat extends StatefulWidget {
  const user_choose_cat({super.key});

  @override
  State<user_choose_cat> createState() => _user_choose_catState();
}

class _user_choose_catState extends State<user_choose_cat> {
...
SizedBox(height: 20,),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: ()  {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>user_searh_questionpaper(cat:selectedcat)));
