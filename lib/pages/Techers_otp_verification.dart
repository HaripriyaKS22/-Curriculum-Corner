...
class Teacher_otphome extends StatelessWidget {

   FirebaseDatabase database = FirebaseDatabase.instance;
  
  String phone,fname,lname,email,institute;
 Teacher_otphome({ required this.fname, required this.lname, required this.email, required this.phone, required this.institute});
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<AuthProvide>(context,listen: false).Teachers_signphone(phone);
    return Scaffold(
              ...
              // }, child: Text("submit")),
               ...
               SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: () async{
                            await Provider.of<AuthProvide>(context,listen: false).Teachers_otpverify(otp.text,fname,lname,phone,email,institute);
