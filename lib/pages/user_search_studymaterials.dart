...
import 'package:curriculum_corner/pages/user_view_studymaterials.dart';
...
class user_searh_studymaterial extends StatefulWidget {
  var cat;
  user_searh_studymaterial({required this.cat});

  @override
  State<user_searh_studymaterial> createState() => _user_searh_studymaterialState();
}

class _user_searh_studymaterialState extends State<user_searh_studymaterial> {
          ...
          child: Text(value),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: ()  {
                            Navigator.push(context, MaterialPageRoute(builder: (context)=>user_view_studymaterial(year:selectedyear,education:selectedValue)));
